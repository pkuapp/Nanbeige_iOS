...
#import "CPEmailSignupViewController.h"


@interface CPEmailSignupViewController ()

@end

@implementation CPEmailSignupViewController
...
{
    [super viewDidLoad];
	self.usernameCell.leftLabel.text = @"Email";
    self.passwordCell.leftLabel.text = @"密码";
    self.usernameCell.rightTextField.keyboardType = UIKeyboardTypeEmailAddress;
    self.passwordCell.rightTextField.secureTextEntry = YES;
    self.passwordCell.rightTextField.keyboardType = UIKeyboardTypeASCIICapable;
    self.usernameCell.rightTextField.returnKeyType = UIReturnKeyNext;
    self.passwordCell.rightTextField.returnKeyType = UIReturnKeyGo;
