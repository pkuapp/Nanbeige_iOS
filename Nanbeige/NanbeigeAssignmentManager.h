...
@protocol AssignmentManagerDelegate <NSObject>
@optional
...
@interface NanbeigeAssignmentManager : NSObject
@property (strong, nonatomic) id<AssignmentManagerDelegate> delegate;
