//
//  NanbeigeLoginCoursesViewController.h
//  Nanbeige
//
...
@interface NanbeigeLoginCoursesViewController : UIViewController <UITableViewDelegate,UITableViewDataSource,UITextFieldDelegate,MBProgressHUDDelegate>{
